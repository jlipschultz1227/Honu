...
##Fit the linear regression model for females
lm_female_laysan <- lm(CCL.avg ~ Year, data = Laysan_trend_dat_F)
summary(lm_female_laysan)

##Fit the linear regression model for males
lm_male_laysan <- lm(CCL.avg ~ Year, data = Laysan_trend_dat_M)
summary(lm_male_laysan)

#Run t-test to compare intercepts
laysan_intercept_test <- t.test(coef(lm(formula = CCL.avg ~ Year, data = Laysan_trend_dat_F)), coef(lm(formula = CCL.avg ~ Year, data = Laysan_trend_dat_M)))
print(laysan_ttest)
